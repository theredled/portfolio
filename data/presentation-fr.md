Je suis développeur freelance, basé sur Nantes et spécialisé en **Symfony**, **architecture back-end**, **React/Next.js**, **intégration**.
...
Spécialisé back-end, j'ai aussi un vrai savoir-faire **frontend**, en intégration **pixel-perfect**, **responsive** et en **interfaces dynamiques** via **React/Next.js** et Vanilla JS.
